#ifndef __NEUTRONGL_MATRIX_TRANSFORM2D_CPP__
#define __NEUTRONGL_MATRIX_TRANSFORM2D_CPP__
...
namespace ntk
{
    namespace Graphics
    {
        ...
        Transform2D Transform2D::translated(const glm::vec2 &translation)
        {
        ...
        Transform2D Transform2D::rotated(float rotation)
        {
            Transform2D result = *this;
        ...
        Transform2D Transform2D::scaled(const glm::vec2 &scale)
        {
            Transform2D result = *this;
            result.scale(scale);
            result.update();
